<template>
  <el-table-column :fixed="item.fixed|| false" :min-width="item.MinWidth" :render-header="renderHeader"
    :prop="item.value" tooltip-effect="light" :show-overflow-tooltip="item.tooltip || false"
    :resizable="item.resizable || false" :label="item.lable" :align="item.align || 'center'"
    :width="item.width || 'auto'" v-if="item.isShow && !item.type && !item.filters" :sortable="item.sort || false">
    <template slot-scope="scope">
      ...
      <template v-else-if="item.type != 'selection' && item.dbclick">
        <div @dblclick="showInput(scope,scope['$index'])">
          ...
          <el-input :class="'index_'+scope['$index']" :ref="scope.column.property+scope['$index']"
            v-if="(scope.row[scope.column.property+scope['$index']])" @blur="editInput(scope,scope['$index'])"
            v-model="scope.row[item.value]" :placeholder="'请输入'+item.lable"></el-input>
        </div>
      </template>
  ...
  <el-table-column :type="item.type || ''" :fixed="item.fixed|| false" :min-width="item.MinWidth"
    :render-header="renderHeader" :prop="item.value" tooltip-effect="light"
    :show-overflow-tooltip="item.tooltip || false" :resizable="item.resizable || false" :label="item.lable"
    :align="item.align || 'center'" :width="item.width || 'auto'" v-else-if="item.isShow && item.type && !item.filters"
  ...
  <el-table-column :fixed="item.fixed|| false" :min-width="item.MinWidth" :render-header="renderHeader"
    :filter-method="filterHandler" :filters="item.filters" :prop="item.value" tooltip-effect="light"
    :show-overflow-tooltip="item.tooltip || false" :resizable="item.resizable || false" :label="item.lable"
    :align="item.align || 'center'" :width="item.width || 'auto'" v-else-if="item.isShow && !item.type && item.filters"
    :sortable="item.sort || false">
    <template slot-scope="scope">
