<template>
  <div>
    <!-- <div style="margin-bottom:100px;"> {{self_from_data}}</div> -->
...
export default {
  ...
  methods: {
    ...
    addToAims () {
      ...
      // 半选中节点数据
      let arrayHalfCheckedNodes = this.$refs[
        'from-tree'
      ].getHalfCheckedNodes();
      console.log(arrayHalfCheckedNodes)
